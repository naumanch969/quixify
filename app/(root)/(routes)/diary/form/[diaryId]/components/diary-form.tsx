...
type Props = {
  initialData?: any | null; // Diary
};

const formSchema = z.object({
  diary: z.string().min(1, { message: 'Diary is required.' }),
...
export const DiaryForm = (props: Props) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      if (props.initialData) {
        await axios.patch(`/api/diary/${props.initialData.id}`, values);
      }
      // CREATE
      else {
            ...
            <div className="space-y-2 w-full">
              <div className="">
                ...
                <p className="text-sm text-muted-foreground ">
                  General information about your Diary
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="col-span-2 md:col-span-1 ">
                    ...
                    <FormDescription>
                      Short description of your diary.
                    </FormDescription>
                    <FormControl>
                      <Input
                        disabled={isLoading}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="col-span-2 md:col-span-1 ">
                    <FormDescription>
                      Why do you wanna achieve this diary?
                    </FormDescription>
                    <FormLabel>
                      Purpose
                      <span className="text-red-500">*</span>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    ...
                    <FormDescription>
                      The date of starting to work to achieve your diary.
                    </FormDescription>
                    <Popover>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    ...
                    <FormDescription>
                      The deadline to achieve your diary.
                    </FormDescription>
                    <Popover>
                      <PopoverTrigger asChild>
                        <FormControl>
